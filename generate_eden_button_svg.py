...
def generate_eden_button_svg():
    ...
    svg_content = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" width="150" height="150">
  <defs>
    <clipPath id="edenCardClip">
      <rect x="7" y="7" width="134" height="134" rx="16" ry="16"/>
    </clipPath>
  </defs>
  ...
  <style>
    ...
    .badge-anim {{
      animation: badgeAnim 6s cubic-bezier(0.68, -0.55, 0.265, 1.55) infinite;
    }}

    .icon-spin {{
      animation: iconSpin 6s cubic-bezier(0.68, -0.55, 0.265, 1.55) infinite;
    }}

    .text-anim {{
      animation: textReveal 6s cubic-bezier(0.68, -0.55, 0.265, 1.55) infinite;
    }}
  ...
  <rect x="11" y="11" width="134" height="134" class="brutalist-shadow"/>

  <!-- Brutalist Card Box -->
  <rect x="7" y="7" width="134" height="134" class="card-bg"/>

  <!-- Animated Circular Logo Badge anchored at (74, 74) -->
  <g class="badge-anim" transform="translate(74, 74)">
    <circle cx="2" cy="2" r="38" fill="#000000"/>
    <circle cx="0" cy="0" r="38" fill="#07150c" stroke="#000000" stroke-width="2.5"/>
    
    <g class="icon-spin">
      <svg x="-20" y="-20" width="40" height="40" viewBox="0 0 24 24" fill="#ffffff">
  ...
  <g class="text-anim">
    ...
    for fname in ["btn-eden-v1.svg", "eden-button.svg", "eden-logo.svg"]:
        ...
        with open(out_path, "w", encoding="utf-8") as f:
            f.write(svg_content)
        ET.fromstring(svg_content)  # Validate XML strictly
        print(f"Generated & Validated XML: {out_path}")
